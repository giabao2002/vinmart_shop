    ...
    <div class="container_12">
        <div class="grid_12 header-repeat">
            <div id="branding">
                ...
                <div class="floatleft middle">
                    <h1>SIÊU THỊ VINMART</h1>
                    <p>www.sieuthivinmart.com</p>
                </div>
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <li class="ic-typography"><a href="changepassword.php"><span>Mật khẩu</span></a></li>';
                <li class="ic-grid-tables"><a href="inbox.php"><span>Đơn hàng</span></a></li>
                <li class="ic-charts"><a href="../index.php"><span>Đến shop</span></a></li>
            </ul>
        </div>
        <div class="clear">
        </div>